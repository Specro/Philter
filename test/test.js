...
describe('Filters', () => {
  ...
  it('anaglyph', function() {
    philter('<div data-philter-anaglyph="1"></div>', (css, svg)=> {
      ...
      expect(svg.replace(/\r?\n|\r/g, '')).to.equal('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="0" height="0" id="philter-svg"><defs><filter id="anaglyph-1" primitiveunits="objectBoundingBox"><fecomponenttransfer x="0" y="0" width="100%" height="100%" color-interpolation-filters="sRGB" result="red"><fefuncr type="table" tablevalues="0 1"></fefuncr><fefuncg type="table" tablevalues="0 0"></fefuncg><fefuncb type="table" tablevalues="0 0"></fefuncb></fecomponenttransfer><fecomponenttransfer x="0" y="0" width="100%" height="100%" color-interpolation-filters="sRGB" in="SourceGraphic" result="blue"><fefuncr type="table" tablevalues="0 0"></fefuncr><fefuncg type="table" tablevalues="0 1"></fefuncg><fefuncb type="table" tablevalues="0 1"></fefuncb></fecomponenttransfer><feoffset in="red" dx="0.01" result="redOff"></feoffset><feblend in2="blue" in="redOff" x="0.01" y="0" mode="difference"></feblend></filter></defs></svg>')
    })
  })
  it('custom', function() {
